<div class="modal fade bwidth" id="shortpolo" tabindex="-1" role="dialog">
                   ...
                   <div class="carousel-inner">
                            ...
                            <div class="col-sm-6 col-md-6">
                                ...
                                <div class="pro-text product-detail">
                                    ...
                                    <a href="#">
                                        <h4>Men's Short Sleeve Polo</h4>


                                    </a>

                                    <p class="price-detail">$25</p>
                                    <p>Red Short Sleeve Polo</p>
                                    <ul class="short-ul">
                                        {{-- <li>filler text</li>
                                        <li>filler text</li>
                                        <li>filler text</li> --}}
                                    ...
                                    <form action="{{route('cart.store')}}" method="POST">
                                        ...
                                        <input type="hidden" name="product_name" value="Men's Short Sleeve Polo">
